...
Normally, we wish $f$ to be a increasing function, i.e., voters with higher NR values have larger voting capacities. Here we give a satisfactory function:
\begin{align}
...
DIP offers voters a reliable ranking list of DApps.\footnote{We assume that voters only care about the ranks of DApps he like, while the developers' rewards are not concerned by voters.} For developers, we need to distribute the rewards to them according to their ranking scores.
