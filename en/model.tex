...
\begin{itemize}
  ...
  ~\cite{Nebulasyellowpaper} proves that a user's NR value is an effective measure of his account's value. So in DIP, NR is also used as a significant criterion to decide users' voting capacity.
