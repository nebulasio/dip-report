...
Currently, most DApps use smart contracts as the backend, and applications on PC,
mobile or web as the frontend.
...
the necessary facilities for DApp developers so that more and more DApp developers
...
users to the DApp platforms. Finally, DApp users produce on-chain data,
increase liquidity, and promote prosperity  of a blockchain system.
