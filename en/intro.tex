...
\whitepaper{
Special Hint: The mauve paper is devoted to Developer Incentive Protocol which is different from the description in our whitepaper (version 1.02 released on April 2018)~\cite{Nabulas} with numerous new upgrades and extensions. This is because we keep thinking and verifying the algorithm in our whitepaper. And now we are more confident and capable to make it more rigorous.
}
