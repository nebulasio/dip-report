...
\node [right=0.05 of d1] {${score}_{1}$};
\node [right=0.05 of d2] {${score}_{2}$};
\node [right=0.05 of d3] {${score}_{3}$};
\node [right=0.05 of d4] {${score}_{4}$};
\node [right=0.05 of d5] {${score}_{5}$};
